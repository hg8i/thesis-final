...
\captionsetup[subfigure]{position=b}
\centering
\subfloat[][]{\label{fig:higgsCrossSection}{\includegraphics[width=0.5\textwidth]{figures/pheno/higgsXsec-mh.pdf}}}
\subfloat[][]{{\includegraphics[width=0.5\textwidth]{figures/pheno/higgsXsec-s.pdf}}}
\label{fig:}
...
\centered{\begin{tikzpicture}\begin{feynman}[small]
    \vertex (p1);
    \vertex [right=3.6em of p1] (p2);
...
\subfloat[][]{{\includegraphics[height=0.20\textheight]{figures/pheno/ci-tchan.pdf}}}
\hspace{0.15\textwidth}%
% \subfloat[][]{{\includegraphics[height=0.20\textheight]{figures/pheno/ciGluon.png}}}
\subfloat[][]{{\includegraphics[height=0.20\textheight]{figures/pheno/ci-gluon.pdf}}}
