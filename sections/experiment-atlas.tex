...
\captionsetup[subfigure]{position=b}
\centering
\subfloat[][]{\label{fig:atlasTile}{\includegraphics[width=0.50\textwidth]{figures/experiment/atlas/tile.pdf}}}
% \subfloat[][]{\label{fig:atlasTile}{\includegraphics[width=0.40\textwidth]{figures/experiment/atlas/tile.png}}}
\subfloat[][]{\label{fig:atlasLar}{\includegraphics[width=0.50\textwidth]{figures/experiment/atlas/lar.pdf}}}
...
\captionsetup[subfigure]{position=b}
\centering
\subfloat[][]{\label{fig:atlasMdt}{\includegraphics[width=0.5\textwidth]{figures/experiment/mdt/drift.pdf}}}
\subfloat[][]{\label{fig:atlasMdt}{\includegraphics[width=0.5\textwidth]{figures/experiment/mdt/chamber.pdf}}}
...
\captionsetup[subfigure]{position=b}
\centering
\subfloat[][]{{\includegraphics[width=0.3\textwidth]{figures/experiment/atlas/mags/end.pdf}}}
\subfloat[][]{{\includegraphics[width=0.3\textwidth]{figures/experiment/atlas/mags/perspective.pdf}}}
\subfloat[][]{{\includegraphics[width=0.3\textwidth]{figures/experiment/atlas/mags/side.pdf}}}
